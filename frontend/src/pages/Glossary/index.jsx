      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid>
            ...
            <h6> A seguir são apresentados em ordem de complexidade os principais termos e expressões que contemplam o domínio do mercado de opções do sistema Underlying:</h6>
