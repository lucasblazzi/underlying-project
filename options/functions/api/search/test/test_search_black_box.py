...
class TestSeach(TestCase):
    ...
    # @mock.patch('search.app.app.query_options', return_value = TestOutput.query_options_output())
...
class TestSeachAsyncio(IsolatedAsyncioTestCase):
    @mock.patch('search.app.app.handler', return_value = TestOutput.handler_output())
