...
def test_dynamo_tables_created(aws_credentials, dynamodb_resource, dynamodb_strategies, region_name="us-east-1"):
    """
...
def test_dynamo_strategies_objects_inserted(aws_credentials, dynamodb_strategies, region_name="us-east-1"):
    """
